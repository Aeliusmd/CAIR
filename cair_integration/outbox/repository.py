        ...
        with pyodbc.connect(self._conn_str) as conn:
            ...
            return [
                ClinicConfig(
                    ...
                    provider_org_id=getattr(row, "provider_org_id", None) or getattr(row, "responsible_org_id", None) or "",
                    responsible_org_id=getattr(row, "provider_org_id", None) or getattr(row, "responsible_org_id", None) or "",
